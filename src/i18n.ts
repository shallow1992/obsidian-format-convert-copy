...
const en = {
	...
	settingsEditorSlackName: "Show \"Copy for Slack\"",
	settingsEditorDiscordName: "Show \"Copy for Discord\"",
	settingsEditorWhatsAppName: "Show \"Copy for WhatsApp\"",
	settingsEditorRawName: "Show \"Copy as raw Markdown\"",
...
const ja: typeof en = {
	...
	settingsEditorSlackName: "「Slack形式でコピー」を表示",
	settingsEditorDiscordName: "「Discord形式でコピー」を表示",
	settingsEditorWhatsAppName: "「WhatsApp形式でコピー」を表示",
	settingsEditorRawName: "「Markdownのままコピー」を表示",
	...
	settingsSilentModeName: "サイレントモード（通知を非表示）",
